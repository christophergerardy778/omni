...
export default {
  ...
  home: {
    ...
    coverage: 'Cobertura',
    coverage_details: '¡Llevamos a tu empresa más lejos! Explora nuestra cobertura',
    ...
    certified_details: 'Nuestras alianzas con los mejores transportistas experimentados nos permite garantizar, que las cargas de nuestros clientes  se entregarán de forma rápida y segura.',
    certified_details_two: '',
    certified_btn: 'Conce más',
    section_three: 'Garantizamos la seguridad de tu mercancía',
    st_details: 'Nos aseguramos que nuestros aliados estratégicos cumplan con las certificaciones y permisos necesarios para poder ser parte de nuestra operación y garantizar un excelente servicio a nuestros clientes.',
  },
  about: {
    title: '<b>Eficiencia</b> en nuestro proceso.<br><b>Siempre.</b>',
    section_one: 'Nosotros',
    so_card_about: [
      {
        ...
        detalle: 'Desde el año 2019, iniciamos operaciones en Laredo Texas. <br/>Día con día nos hemos posicionado como una de las mejores prestadoras de servicios de logística en la frontera de México con Estados Unidos.',
      },
      {
        ...
        detalle: 'Es importante para el equipo OMNI, siempre tener presente los valores de: confianza, innovación, experiencia y la seguridad.',
      },
      {
        titulo: 'Visión',
        ...
        detalle: 'Crear la red de transporte más eficiente de América del Norte. Continuamente buscamos nuevas formas en que nuestra gente, procesos y tecnología puedan usarse para hacer avanzar el transporte de carga.',
      },
      {
    ...
    headquarters: 'Centro de Operaciones OMNI',
    h_details: 'Con oficinas en Estados Unidos y México, trabajamos para brindarle soluciones cerca de usted.',
    h_unites: '<b>Estados Unidos</b> <br/> Laredo Texas <br/> Fresno California',
  ...
  services: {
    ...
    so_subtitle: '¡Queremos ser parte de tu cadena de distribución y suministro!',
    so_details: 'Nuestro conocimiento del mercado y experiencia, aunado a las alianzas y relaciones comerciales que hemos forjado con compañías de transporte, nos permiten obtener costos competitivos y mejores condiciones de servicio.',
    so_crads: [
      {
        id: 'storage',
        titulo: 'Almacenaje',
    ...
    industry: 'Industria',
    i_subtitle: '¿Tiene mercancía que necesita trasladar? ¡Somos su mejor opción! Abarcamos los siguientes sectores:',
    i_cards: [
      {
        id: 'auto',
        titulo: 'Automotriz',
    ...
    tech: 'Tecnología',
    t_subtitle: 'Las  tecnologías  de soporte logístico y nuestro equipo de desarrollo de sistemas interno nos  ayudan a operar de manera eficiente y son la clave de nuestro éxito de operación logística.',
    t_one: 'Tecnología líder en la industria',
    t_two: 'Gestión de Inventario',
    t_three: 'Seguimiento en tiempo real y de cobertura 24/7',
    t_four: 'Utilizamos programas de rastreo como por ejemplo: Four Kites, Macro Point, entre otros',
  ...
  coverage: {
    ...
    mex: 'México<br>Puntos Logísticos:',
    c_mex: [
      'Nuevo León',
      'Jalisco',
      'Coahuila',
  ...
  c_usa: [
    '(Excepto Alaska y Hawai)'
    ],
  },
  contact: {
    title: 'Agenda una llamada con nosotros <b>¡Contáctenos!</b>',
    section_one: '¿Necesita cotizar un servicio?',
    so_details: 'Envíenos su información y en breve nos comunicaremos con usted.<br><br>Nuestro equipo está listo para ayudarlo. Déjenos un mensaje detallado sobre sus requisitos y estaremos encantados de presentarle soluciones a su problema.',
    ff_name: 'Nombre',
    ...
    st_details: 'Queremos formar una asociación sólida y permanente con personas apasionadas por la industria del transporte y la logística, conviértase en un  Transportista OMNI  y tenga éxito en sus propios términos.',
    sf_name: 'Nombre',
    sf_phone: 'Teléfono',
    sf_email: 'Email',
    sf_company: 'Empresa',
  ...
  fotter: {
    details: 'Omni International Logistics es más que una agencia de logística, somos su solución completa de comercio transfronterizo. Conozca de dónde venimos y hacia dónde nos dirigimos.',
    contact: 'Contacto',
    locations: 'Oficinas',
