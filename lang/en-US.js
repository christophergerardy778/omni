export default {
  header: {
    ...
    contact: 'Contact Us',
    c_quote: 'Quote',
    c_carriers: 'Omni Carrier',
  },
  home: {
    title: 'Logistics services in México and United States',
    subtitle: 'We help you make it possible',
    section_one: 'We want to be part of your supply and distribution chain!',
    storage: 'Storage',
    storage_view: 'View Service',
    transport: 'Land Transport',
    transport_view: 'View Service',
    distribution: 'Transport & Distribution',
    distribution_view: 'View Service',
    export: 'Import & Export',
    export_view: 'View Service',
    section_two: 'Reasons why we are your best option!',
    st_one: 'Solutions up to scale: We offer experience and flexibility to satisfy any type of project',
    st_two: 'Track & Trace: Constant monitoring of merchandise visualizing load’s location at all times',
    st_three: 'Competitive rates: Maintaining quality in our services every time',
    st_four: 'Guaranteed safety: Making sure our strategic partners comply with our necesary permits in order to be part of our operation and guarantee the safety of your load',
    coverage: 'Coverage',
