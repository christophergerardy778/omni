<template>
  <v-container fluid class="pa-0">
      ...
      >
        <v-row justify="center" align="center">
          ...
          <v-col v-if="$vuetify.breakpoint.smAndDown" cols="6">
            <v-row>
              <v-col cols="12" class="subTituloMobile text-center">
                {{ titulo }}
              </v-col>
            </v-row>
          </v-col>
        ...
        <v-row v-if="!$vuetify.breakpoint.smAndDown">
          <v-col cols="12" class="subTituloSimple">
            {{ titulo }}
          </v-col>
          <v-col lg="10" md="10" sm="11" cols="11" class="textoSimple">
            {{ detalle }}
          </v-col>
        </v-row>
      </v-card-text>
    ...
    <v-row class="mt-3 px-4" v-if="$vuetify.breakpoint.smAndDown">
      <v-col cols="12" class="textoMobil">
        {{ detalle }}
      </v-col>
    </v-row>
  </v-container>
